...
#ifndef OPEN_SPIEL_GAMES_KUHN_POKER_MP_H_
#define OPEN_SPIEL_GAMES_KUHN_POKER_MP_H_
...
class KuhnGame : public Game {
 public:
  ...
  int MaxChanceOutcomes() const override { return num_cards_; }
 ...
 private:
  // Number of players.
  int num_players_;
  // Number of cards, num_cards >= num_players
  int num_cards_;
};
...
#endif  // OPEN_SPIEL_GAMES_KUHN_POKER_MP_H_
